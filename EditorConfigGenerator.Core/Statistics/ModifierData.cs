...
public sealed class ModifierData
	: StatisticalData<ModifierData>, IEquatable<ModifierData?>
{
	public ModifierData()
	...
	public override int GetHashCode() => this.ToString().GetHashCode(StringComparison.InvariantCulture);
	...
	public ImmutableDictionary<string, (uint weight, uint frequency)> VisibilityModifiers { get; } =
	...
	public ImmutableDictionary<string, (uint weight, uint frequency)> OtherModifiers { get; } =
		new Dictionary<string, (uint weight, uint frequency)>
		{
