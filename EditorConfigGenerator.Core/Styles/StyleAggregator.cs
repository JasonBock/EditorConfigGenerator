...
public sealed class StyleAggregator
{
	public StyleAggregator Update(StyleAggregator aggregator)
	{
		...
		return new StyleAggregator() { Set = this.Set.Update(aggregator.Set) };
	}
	...
	private sealed class StyleSet
		: IStyleSet
	{
		public IStyleSet Update(IStyleSet styleSet) =>
			new StyleSet()
			{
				CSharpNewLineBeforeCatchStyle =
					this.CSharpNewLineBeforeCatchStyle.Add(styleSet.CSharpNewLineBeforeCatchStyle),
				CSharpNewLineBeforeElseStyle =
					this.CSharpNewLineBeforeElseStyle.Add(styleSet.CSharpNewLineBeforeElseStyle),
				CSharpNewLineBeforeFinallyStyle =
					this.CSharpNewLineBeforeFinallyStyle.Add(styleSet.CSharpNewLineBeforeFinallyStyle),
				CSharpNewLineBeforeMembersInAnonymousTypesStyle =
					this.CSharpNewLineBeforeMembersInAnonymousTypesStyle.Add(styleSet.CSharpNewLineBeforeMembersInAnonymousTypesStyle),
				CSharpNewLineBeforeMembersInObjectInitializersStyle =
					this.CSharpNewLineBeforeMembersInObjectInitializersStyle.Add(styleSet.CSharpNewLineBeforeMembersInObjectInitializersStyle),
				CSharpNewLineBetweenQueryExpressionClausesStyle =
					this.CSharpNewLineBetweenQueryExpressionClausesStyle.Add(styleSet.CSharpNewLineBetweenQueryExpressionClausesStyle),
				CSharpPreferBracesStyle =
					this.CSharpPreferBracesStyle.Add(styleSet.CSharpPreferBracesStyle),
				CSharpPreferredModifierOrderStyle =
					this.CSharpPreferredModifierOrderStyle.Add(styleSet.CSharpPreferredModifierOrderStyle),
				CSharpPreferSimpleDefaultExpressionStyle =
					this.CSharpPreferSimpleDefaultExpressionStyle.Add(styleSet.CSharpPreferSimpleDefaultExpressionStyle),
				CSharpPreserveSingleLineBlocksStyle =
					this.CSharpPreserveSingleLineBlocksStyle.Add(styleSet.CSharpPreserveSingleLineBlocksStyle),
				CSharpSpaceAfterCastStyle =
					this.CSharpSpaceAfterCastStyle.Add(styleSet.CSharpSpaceAfterCastStyle),
				CSharpSpaceAfterKeywordsInControlFlowStatementsStyle =
					this.CSharpSpaceAfterKeywordsInControlFlowStatementsStyle.Add(styleSet.CSharpSpaceAfterKeywordsInControlFlowStatementsStyle),
				CSharpSpaceBetweenMethodCallParameterListParenthesesStyle =
					this.CSharpSpaceBetweenMethodCallParameterListParenthesesStyle.Add(styleSet.CSharpSpaceBetweenMethodCallParameterListParenthesesStyle),
				CSharpSpaceBetweenMethodDeclarationParameterListParenthesesStyle =
					this.CSharpSpaceBetweenMethodDeclarationParameterListParenthesesStyle.Add(styleSet.CSharpSpaceBetweenMethodDeclarationParameterListParenthesesStyle),
				CSharpSpaceBetweenParenthesesStyle =
					this.CSharpSpaceBetweenParenthesesStyle.Add(styleSet.CSharpSpaceBetweenParenthesesStyle),
				CSharpStyleExpressionBodiedAccessorsStyle =
					this.CSharpStyleExpressionBodiedAccessorsStyle.Add(styleSet.CSharpStyleExpressionBodiedAccessorsStyle),
				CSharpStyleExpressionBodiedConstructorsStyle =
					this.CSharpStyleExpressionBodiedConstructorsStyle.Add(styleSet.CSharpStyleExpressionBodiedConstructorsStyle),
				CSharpStyleExpressionBodiedIndexersStyle =
					this.CSharpStyleExpressionBodiedIndexersStyle.Add(styleSet.CSharpStyleExpressionBodiedIndexersStyle),
				CSharpStyleExpressionBodiedMethodsStyle =
					this.CSharpStyleExpressionBodiedMethodsStyle.Add(styleSet.CSharpStyleExpressionBodiedMethodsStyle),
				CSharpStyleExpressionBodiedOperatorsStyle =
					this.CSharpStyleExpressionBodiedOperatorsStyle.Add(styleSet.CSharpStyleExpressionBodiedOperatorsStyle),
				CSharpStyleExpressionBodiedPropertiesStyle =
					this.CSharpStyleExpressionBodiedPropertiesStyle.Add(styleSet.CSharpStyleExpressionBodiedPropertiesStyle),
				CSharpStyleInlinedVariableDeclarationStyle =
					this.CSharpStyleInlinedVariableDeclarationStyle.Add(styleSet.CSharpStyleInlinedVariableDeclarationStyle),
				CSharpStylePatternLocalOverAnonymousFunctionStyle =
					this.CSharpStylePatternLocalOverAnonymousFunctionStyle.Add(styleSet.CSharpStylePatternLocalOverAnonymousFunctionStyle),
				CSharpStylePatternMatchingOverAsWithNullCheckStyle =
					this.CSharpStylePatternMatchingOverAsWithNullCheckStyle.Add(styleSet.CSharpStylePatternMatchingOverAsWithNullCheckStyle),
				CSharpStyleVarElsewhereStyle =
					this.CSharpStyleVarElsewhereStyle.Add(styleSet.CSharpStyleVarElsewhereStyle),
				CSharpStyleVarForBuiltInTypesStyle =
					this.CSharpStyleVarForBuiltInTypesStyle.Add(styleSet.CSharpStyleVarForBuiltInTypesStyle),
				CSharpStyleVarWhenTypeIsApparentStyle =
					this.CSharpStyleVarWhenTypeIsApparentStyle.Add(styleSet.CSharpStyleVarWhenTypeIsApparentStyle),
				DotnetSortSystemDirectivesFirstStyle =
					this.DotnetSortSystemDirectivesFirstStyle.Add(styleSet.DotnetSortSystemDirectivesFirstStyle),
				DotnetStyleExplicitTupleNamesStyle =
					this.DotnetStyleExplicitTupleNamesStyle.Add(styleSet.DotnetStyleExplicitTupleNamesStyle),
				DotnetStyleObjectInitializerStyle =
					this.DotnetStyleObjectInitializerStyle.Add(styleSet.DotnetStyleObjectInitializerStyle),
				DotnetStylePredefinedTypeForLocalsParametersMembersStyle =
					this.DotnetStylePredefinedTypeForLocalsParametersMembersStyle.Add(styleSet.DotnetStylePredefinedTypeForLocalsParametersMembersStyle),
				DotnetStylePredefinedTypeForMemberAccessStyle =
					this.DotnetStylePredefinedTypeForMemberAccessStyle.Add(styleSet.DotnetStylePredefinedTypeForMemberAccessStyle),
				DotnetStylePreferInferredAnonymousTypeMemberNamesStyle =
					this.DotnetStylePreferInferredAnonymousTypeMemberNamesStyle.Add(styleSet.DotnetStylePreferInferredAnonymousTypeMemberNamesStyle),
				DotnetStylePreferInferredTupleNamesStyle =
					this.DotnetStylePreferInferredTupleNamesStyle.Add(styleSet.DotnetStylePreferInferredTupleNamesStyle),
				DotnetStyleQualificationForEventStyle =
					this.DotnetStyleQualificationForEventStyle.Add(styleSet.DotnetStyleQualificationForEventStyle),
				DotnetStyleQualificationForFieldStyle =
					this.DotnetStyleQualificationForFieldStyle.Add(styleSet.DotnetStyleQualificationForFieldStyle),
				DotnetStyleQualificationForMethodStyle =
					this.DotnetStyleQualificationForMethodStyle.Add(styleSet.DotnetStyleQualificationForMethodStyle),
				DotnetStyleQualificationForPropertyStyle =
					this.DotnetStyleQualificationForPropertyStyle.Add(styleSet.DotnetStyleQualificationForPropertyStyle),
				DotnetStyleRequireAccessibilityModifiersStyle =
					this.DotnetStyleRequireAccessibilityModifiersStyle.Add(styleSet.DotnetStyleRequireAccessibilityModifiersStyle),
				IndentStyleStyle =
					this.IndentStyleStyle.Add(styleSet.IndentStyleStyle)
			};
