...
namespace EditorConfigGenerator.Core.Tests.Styles
{
   [TestFixture]
	public static class CSharpStyleExpressionBodiedMethodsStyleTests
	{
		...
		{
			var style1 = new CSharpStyleExpressionBodiedMethodsStyle(new ExpressionBodiedData(9u, 2u, 3u, 4u));
			var style2 = new CSharpStyleExpressionBodiedMethodsStyle(new ExpressionBodiedData(90u, 20u, 30u, 40u));
