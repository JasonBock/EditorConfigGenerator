...
namespace EditorConfigGenerator.Core.Tests.Styles
{
	...
	public static class DotnetStyleExplicitTupleNamesStyleTests
	{
		...
		public static void CreateWithMoreFalseData()
		{
			...
			var style = new DotnetStyleExplicitTupleNamesStyle(data);
			Assert.That(style.Data, Is.SameAs(data), nameof(style.Data));
			Assert.That(style.GetSetting(), Is.EqualTo("dotnet_style_explicit_tuple_names = false:error"), nameof(style.GetSetting));
		}
		...
		public static void CreateWithMoreTrueData()
		{
			...
			var style = new DotnetStyleExplicitTupleNamesStyle(data);
			Assert.That(style.Data, Is.SameAs(data), nameof(style.Data));
			Assert.That(style.GetSetting(), Is.EqualTo("dotnet_style_explicit_tuple_names = true:error"), nameof(style.GetSetting));
		}

		[Test]
		public static void Add()
		{
			var style1 = new DotnetStyleExplicitTupleNamesStyle(new BooleanData(1u, 2u, 3u));
			var style2 = new DotnetStyleExplicitTupleNamesStyle(new BooleanData(10u, 20u, 30u));
