...
namespace EditorConfigGenerator.Core.Tests.Styles
{
	...
	public static class DotnetStylePredefinedTypeForMemberAccessStyleTests
	{
		...
		public static void CreateWithMoreFalseData()
		{
			...
			var style = new DotnetStylePredefinedTypeForMemberAccessStyle(data);
			Assert.That(style.Data, Is.SameAs(data), nameof(style.Data));
			Assert.That(style.GetSetting(), Is.EqualTo("dotnet_style_predefined_type_for_member_access = false:error"), nameof(style.GetSetting));
		}
		...
		public static void CreateWithMoreTrueData()
		{
			...
			var style = new DotnetStylePredefinedTypeForMemberAccessStyle(data);
			Assert.That(style.Data, Is.SameAs(data), nameof(style.Data));
			Assert.That(style.GetSetting(), Is.EqualTo("dotnet_style_predefined_type_for_member_access = true:error"), nameof(style.GetSetting));
		}
