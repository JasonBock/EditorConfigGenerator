...
public static class DotnetStylePredefinedTypeForMemberAccessStyleTests
{
	...
	{
		var style1 = new DotnetStylePredefinedTypeForMemberAccessStyle(new BooleanData(3u, 1u, 2u));
		var style2 = new DotnetStylePredefinedTypeForMemberAccessStyle(new BooleanData(30u, 10u, 20u));
