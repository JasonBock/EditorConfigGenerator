...
namespace EditorConfigGenerator.Core.Tests.Styles
{
	...
	public static class DotnetStyleQualificationForEventStyleTests
	{
		...
		public static void CreateWithMoreFalseData()
		{
			...
			var style = new DotnetStyleQualificationForEventStyle(data);
			Assert.That(style.Data, Is.SameAs(data), nameof(style.Data));
			Assert.That(style.GetSetting(), Is.EqualTo("dotnet_style_qualification_for_event = false:error"), nameof(style.GetSetting));
		}
		...
		public static void CreateWithMoreTrueData()
		{
			...
			var style = new DotnetStyleQualificationForEventStyle(data);
			Assert.That(style.Data, Is.SameAs(data), nameof(style.Data));
			Assert.That(style.GetSetting(), Is.EqualTo("dotnet_style_qualification_for_event = true:error"), nameof(style.GetSetting));
		}
