...
namespace EditorConfigGenerator.Core.Tests.Styles
{
	...
	public static class CSharpStyleInlinedVariableDeclarationStyleTests
	{
		...
		{
			var style1 = new CSharpStyleInlinedVariableDeclarationStyle(new BooleanData(1u, 2u, 3u));
			var style2 = new CSharpStyleInlinedVariableDeclarationStyle(new BooleanData(10u, 20u, 30u));
