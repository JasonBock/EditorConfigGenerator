...
namespace EditorConfigGenerator.Core.Tests.Styles
{
	...
	public static class CSharpStyleInlinedVariableDeclarationStyleTests
	{
		...
		public static void CreateWithCustomSeverity()
		{
			...
			var style = new CSharpStyleInlinedVariableDeclarationStyle(data, suggestion);
		...
		{
			var data = new BooleanData();
			var style = new CSharpStyleInlinedVariableDeclarationStyle(data);
		...
		public static void CreateWithMoreFalseData()
		{
			...
			Assert.That(style.GetSetting(), Is.EqualTo(
				$"{CSharpStyleInlinedVariableDeclarationStyle.Setting} = false:{style.Severity.GetDescription()}"), nameof(style.GetSetting));
		}
		...
		public static void CreateWithMoreTrueData()
		{
			...
			Assert.That(style.Data, Is.SameAs(data), nameof(style.Data));
			Assert.That(style.GetSetting(), Is.EqualTo(
				$"{CSharpStyleInlinedVariableDeclarationStyle.Setting} = true:{style.Severity.GetDescription()}"), nameof(style.GetSetting));
		}

		[Test]
		public static void Add()
		{
			var style1 = new CSharpStyleInlinedVariableDeclarationStyle(new BooleanData(3u, 1u, 2u));
			var style2 = new CSharpStyleInlinedVariableDeclarationStyle(new BooleanData(30u, 10u, 20u));
		...
		{
			var style = new CSharpStyleInlinedVariableDeclarationStyle(new BooleanData());
		...
		[Test]
		public static void UpdateWithInlineDeclaration()
		{
			var style = new CSharpStyleInlinedVariableDeclarationStyle(new BooleanData(default, default, default));

			var statement = (ArgumentSyntax)SyntaxFactory.ParseStatement("Foo(out int x)", options: Shared.ParseOptions)
				.DescendantNodes().Single(_ => _.Kind() == SyntaxKind.Argument);
		...
		[Test]
		public static void UpdateWithNoInlineDeclaration()
		{
			var style = new CSharpStyleInlinedVariableDeclarationStyle(new BooleanData(default, default, default));

			var statement = (ArgumentSyntax)SyntaxFactory.ParseStatement("Foo(out x)", options: Shared.ParseOptions)
				.DescendantNodes().Single(_ => _.Kind() == SyntaxKind.Argument);
			var newStyle = style.Update(statement);
		...
		[Test]
		public static void UpdateWithNoOutArgument()
		{
			var style = new CSharpStyleInlinedVariableDeclarationStyle(new BooleanData(default, default, default));

			var statement = (ArgumentSyntax)SyntaxFactory.ParseStatement("Foo(x)", options: Shared.ParseOptions)
				.DescendantNodes().Single(_ => _.Kind() == SyntaxKind.Argument);
			var newStyle = style.Update(statement);
		...
		public static void UpdateWithDiagnostics()
		{
			...
			var statement = (ArgumentSyntax)SyntaxFactory.ParseStatement("Foo(*)", options: Shared.ParseOptions)
				.DescendantNodes().Single(_ => _.Kind() == SyntaxKind.Argument);
			var newStyle = style.Update(statement);
