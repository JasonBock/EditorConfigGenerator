...
namespace EditorConfigGenerator.Core.Tests.Styles
{
	...
	public static class CSharpPreferBracesStyleTests
	{
		...
		public static void CreateWithMoreFalseData()
		{
			...
			var style = new CSharpPreferBracesStyle(data);
			Assert.That(style.Data, Is.SameAs(data), nameof(style.Data));
			Assert.That(style.GetSetting(), Is.EqualTo("csharp_prefer_braces = false:error"), nameof(style.GetSetting));
		}
		...
		public static void CreateWithMoreTrueData()
		{
			...
			var style = new CSharpPreferBracesStyle(data);
			Assert.That(style.Data, Is.SameAs(data), nameof(style.Data));
			Assert.That(style.GetSetting(), Is.EqualTo("csharp_prefer_braces = true:error"), nameof(style.GetSetting));
		}
