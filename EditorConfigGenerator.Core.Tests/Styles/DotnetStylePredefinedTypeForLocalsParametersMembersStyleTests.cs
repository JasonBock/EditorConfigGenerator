...
public static class DotnetStylePredefinedTypeForLocalsParametersMembersStyleTests
{
	...
	public static void CreateWithMoreFalseData()
	{
		...
		Assert.That(style.GetSetting(), Is.EqualTo(
			$"{DotnetStylePredefinedTypeForLocalsParametersMembersStyle.Setting} = false:{style.Severity.GetDescription()}"), nameof(style.GetSetting));
	}
	...
	public static void CreateWithMoreTrueData()
	{
		...
		Assert.That(style.Data, Is.SameAs(data), nameof(style.Data));
		Assert.That(style.GetSetting(), Is.EqualTo(
			$"{DotnetStylePredefinedTypeForLocalsParametersMembersStyle.Setting} = true:{style.Severity.GetDescription()}"), nameof(style.GetSetting));
	}
