...
namespace EditorConfigGenerator.Core.Tests.Styles
{
	...
	public static class CSharpStylePatternMatchingOverAsWithNullCheckStyleTests
	{
		...
		{
			var style1 = new CSharpStylePatternMatchingOverAsWithNullCheckStyle(new BooleanData(1u, 2u, 3u));
			var style2 = new CSharpStylePatternMatchingOverAsWithNullCheckStyle(new BooleanData(10u, 20u, 30u));
