...
namespace EditorConfigGenerator.Core.Tests.Styles
{
	...
	public static class DotnetStyleQualificationForPropertyStyleTests
	{
		...
		{
			var style1 = new DotnetStyleQualificationForPropertyStyle(new BooleanData(1u, 2u, 3u));
			var style2 = new DotnetStyleQualificationForPropertyStyle(new BooleanData(10u, 20u, 30u));
