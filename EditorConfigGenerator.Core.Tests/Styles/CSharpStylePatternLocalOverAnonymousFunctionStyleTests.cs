...
namespace EditorConfigGenerator.Core.Tests.Styles
{
	...
	public static class CSharpStylePatternLocalOverAnonymousFunctionStyleTests
	{
		...
		{
			var style1 = new CSharpStylePatternLocalOverAnonymousFunctionStyle(new BooleanData(1u, 2u, 3u));
			var style2 = new CSharpStylePatternLocalOverAnonymousFunctionStyle(new BooleanData(10u, 20u, 30u));
