...
namespace EditorConfigGenerator.Core.Tests.Styles
{
	...
	public static class CSharpNewLineBetweenQueryExpressionClausesStyleTests
	{
		...
		{
			var style1 = new CSharpNewLineBetweenQueryExpressionClausesStyle(new BooleanData(1u, 2u, 3u));
			var style2 = new CSharpNewLineBetweenQueryExpressionClausesStyle(new BooleanData(10u, 20u, 30u));
...
}", options: Shared.ParseOptions).DescendantNodes().Single(_ => _.Kind() == SyntaxKind.QueryExpression) as QueryExpressionSyntax;
